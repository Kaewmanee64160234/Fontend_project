                        ...
                        <tr>
                          <td class="content-block">
                            <table class="invoice">
                              <tbody>
                                <tr>
                                  <td>customer: {{ orderStore.tempOrder.customerId }}<br /> order: {{ orderStore.tempOrder.id }}<br />Date :{{ orderStore.tempOrder.createdDate }}<br /> payment: {{ orderStore.tempOrder.payment }}</td>
                                </tr>
                                <tr>
                                  <td>
