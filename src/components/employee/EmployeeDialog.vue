          ...
          <v-form ref="form">
            <v-container>
              <v-row justify="center">
                <v-avatar size="80"
                  ><v-img
                    :src="`${url}/employees/image/${employeeStore.editEmployee.image}`"
                  ></v-img
                ></v-avatar>
              </v-row>
              <v-row>
                <v-col cols="12">
                  <v-text-field
                    label="name*"
                    required
                    v-model="employeeStore.editEmployee.name"
                ...
                <v-col cols="12">
                  <v-text-field
                    label="address*"
                    required
                    v-model="employeeStore.editEmployee.address"
                ...
                <v-col cols="12">
                  <v-text-field
                    label="tel*"
                    required
                    v-model="employeeStore.editEmployee.tel"
                ...
                <v-col cols="12">
                  <v-text-field
                    label="email*"
                    required
                    v-model="employeeStore.editEmployee.email"
                ...
                <v-col cols="12">
                  <v-text-field
                    label="position*"
                    required
                    v-model="employeeStore.editEmployee.position"
                ...
                <v-col cols="12">
                  <v-file-input
                    ...
                    v-model="employeeStore.editEmployee.files"
