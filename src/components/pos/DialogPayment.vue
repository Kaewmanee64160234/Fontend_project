...
<template>
  <v-dialog v-model="pointOfSaleStore.dialogPayment" persistent width="230px">
          <v-card>
            ...
            <v-card-actions>
              <v-spacer></v-spacer>
              <v-btn color="red" variant="text" @click="pointOfSaleStore.dialogPayment = false"> Cancel </v-btn>
